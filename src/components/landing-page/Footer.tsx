    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Middle section with rich content (language-specific) or default navigation links */}
          {(i18n.language === "ar" && footerSettings.middleContentAr) ||
          (i18n.language !== "ar" && footerSettings.middleContent) ? (
            <div
              style={{
                flex: 1,
                display: "flex",
